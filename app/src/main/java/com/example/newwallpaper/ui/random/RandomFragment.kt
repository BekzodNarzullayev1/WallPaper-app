package com.example.newwallpaper.ui.random
...
import com.example.newwallpaper.databinding.FragmentRandomBinding
...
class RandomFragment : Fragment() {
    ...
    lateinit var randomList: ArrayList<Hit>
    ...
    override fun onCreateView(
            ...
            override fun onResponse(call: Call<PhotoData>, response: Response<PhotoData>) {
                if (response.isSuccessful) {
                    for (i in response.body()?.hits!!.indices) {
                        randomList.add(response.body()?.hits!![i])
                    }
                }
            }
        ...
        photoAdapter = PhotoAdapter(randomList,object :PhotoAdapter.OnItemClickListener{
